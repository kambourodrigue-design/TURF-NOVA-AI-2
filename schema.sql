...
CREATE TABLE IF NOT EXISTS predictions (
  ...
  -- 1 = ce pronostic correspond à la "course mise en avant" (course du jour) au
  -- moment où elle a été affichée à un visiteur. Sert de filtre pour que les
  -- statistiques de réussite publiques ne portent que sur un échantillon
  -- systématique (1 course/jour, choisie avant le résultat) plutôt que sur les
  -- courses arbitrairement cliquées par les visiteurs via "Analyser une course".
...
-- Idem si ta table `predictions` existe déjà (ajout de la colonne mise_en_avant) :
-- ALTER TABLE predictions ADD COLUMN mise_en_avant INTEGER NOT NULL DEFAULT 0;
