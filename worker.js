    ...
    return new Response(
      JSON.stringify({
        ...
        message: acces.essaiExpire
          ...
          : "Un abonnement actif (essai, Turfiste ou Prestige) est nécessaire pour voir les pronostics IA.",
      }),
...
const PLANS_VALIDES = ["gratuit", "essai", "turfiste", "prestige"];
...
async function verifierAccesPremium(env, email) {
  ...
  if (sub.plan === "essai" || sub.plan === "turfiste" || sub.plan === "prestige") {
