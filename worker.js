...
function construireSelectionGratuite(participants, quarte8) {
  ...
  const toItem = (p) => ({ numero: p.numPmu, cheval: p.nom });
...
async function handleCourseDuJour(request, env) {
  ...
  if (!full) {
    try {
      ...
      const gratuit = construireSelectionGratuite(participants, quarte8);
